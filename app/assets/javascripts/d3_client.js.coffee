$(document).ready ->
  ...
  # d3.json('/api/owl.json', (error, flare) ->
  #   root = flare
  #   root.x0 = height / 2
  #   root.y0 = 0
  ...
  # d3.select(self.frameElement).style('heigth', '800px')

  # update = (source) ->
  #   # Compute the new tree layout
  #   nodes = tree.nodes(root).reverese()
  ...
  #   # Enter any new nodes at the paret's previuos position
  ...
  #            .attr('r', 1e-6)
  #            .style('fill', (d) -> 
  #             if d._children || d.children then '#fff' else 'lightsteelblue'
  #            )
  ...
  #             .attr('r', 4.5)
  #             .style('fill', (d) -> if d.children || d._children then '#fff' else 'lightsteelblue')
  ...
  update = (source) ->
    ...
    nodeEnter.append('circle').attr('r', 1e-6).style 'fill', (d) ->
      if d.children or d._children then '#fff' else 'lightsteelblue'
